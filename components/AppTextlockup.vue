<template>
  <div class="textlockup container">
    <div class="img" style="text-align: right">
      <slot name="img">
        <img src="/bee-front.jpg" alt="shoe" />
      </slot>
    </div>
    <div class="new">
      <slot name="new"></slot>
    ...
    <div class="sale">
      <slot name="sale">Sansa Pascal</slot>
    </div>
    <div class="collection">
      <slot name="collection">Miel Nectar Forêt</slot>
    </div>
    <div class="details">
      <slot name="details">Collectif Secrets Abeilles</slot>
    </div>
  </div>
</template>
